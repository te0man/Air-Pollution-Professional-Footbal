...
#data:  no2sunPSG$no2 and no2sunNOT$no2
...
#data:  no2satPSG$no2 and no2satNOT$no2
...
#data:  no2wedPSG$no2 and no2wedNOT$no2
#t = 1.1407, df = 39.622, p-value = 0.2608
#alternative hypothesis: true difference in means is not equal to 0
#95 percent confidence interval:
#  -2.039218  7.320354
#sample estimates:
...
data:  no2NORMsunPSG$no2 and no2NORMsunNOT$no2
t = 1.1232, df = 31.974, p-value = 0.2697
alternative hypothesis: true difference in means is not equal to 0
95 percent confidence interval:
  -0.4848077  1.6765385
sample estimates:
...
data:  no2NORMsatPSG$no2 and no2NORMsatNOT$no2
t = 2.9485, df = 47.32, p-value = 0.004948
alternative hypothesis: true difference in means is not equal to 0
95 percent confidence interval:
  0.3881071 2.0542047
sample estimates:
